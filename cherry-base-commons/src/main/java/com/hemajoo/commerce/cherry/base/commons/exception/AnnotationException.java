...
/**
 * Exception thrown to indicate an error occurred when manipulating an annotation.
 * @author <a href="mailto:christophe.resse@gmail.com">Christophe Resse</a>
 * @version 1.0.0
 */
public class AnnotationException extends CherryException
{
    /**
     * Thrown to indicate that an error occurred when manipulating an annotation.
     *
